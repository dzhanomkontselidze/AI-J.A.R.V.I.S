...
✨ Можливості
КомандаОпис💬 (без команди)Чат з JARVIS — відповідає на будь-яке повідомлення/startПривітальне повідомлення з представленням JARVIS/image [запит]Генерація зображення через Stability AI/test [текст]Створення квізу з будь-якого наданого тексту/helpПоказати доступні команди
...
Google Gemini — AI чат та відповіді
Stability AI — Генерація зображень
...
Google Gemini API ключ (з aistudio.google.com)
Stability AI API ключ (з platform.stability.ai)

Інструкція

Клонуй репозиторій

bashgit clone https://github.com/YOUR_USERNAME/jarvis-telegram-bot

Імпортуй workflow в n8n
...
Додай свої облікові дані в n8n
...
n8n Cloud безкоштовний рівень додає футер "powered by n8n" — для видалення потрібен self-host
